...
you can clone the project or download it as Zip file.
 Clone the repository:
   ```bash
   git clone https://github.com/olahasan/Simple-Layout-Bootstrap-5-iti.git
```
...
- Solution URL: [here](https://github.com/olahasan/Simple-Layout-Bootstrap-5-iti)

- Live Site URL: [here](https://olahasan.github.io/Simple-Layout-Bootstrap-5-iti/)


 ## Screenshot
 
![Screenshot](./imgs/Simple-Layout.png)
